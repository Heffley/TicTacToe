...
public class Con4GameFragment extends Fragment {
    ...
    private Con4GameViewModel mViewModel;

    public static Con4GameFragment newInstance() {
        return new Con4GameFragment();
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(Con4GameViewModel.class);
